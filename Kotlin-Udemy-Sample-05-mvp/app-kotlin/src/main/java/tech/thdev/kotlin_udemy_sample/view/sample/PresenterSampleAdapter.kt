...
class PresenterSampleAdapter(private val context: Context) :
        RecyclerView.Adapter<PresenterSampleAdapter.PresenterSampleViewHolder>() {
    ...
    inner class PresenterSampleViewHolder(parent: ViewGroup) :
            RecyclerView.ViewHolder(
                    LayoutInflater.from(context).inflate(R.layout.item_sample, parent, false)
            ) {
